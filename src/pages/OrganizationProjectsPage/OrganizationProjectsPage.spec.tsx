...
export const orgHandler = rest.get(deltaPath('/orgs/orgLabel'), (_, res, ctx) => {
  const mockResponse: Organization = {
    ...
    _createdBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/orgLabel',
    _deprecated: false,
    _label: 'orgLabel',
    _rev: 1,
    _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/orgs/Analysis-Plugin',
    _updatedAt: '2023-04-20T07:52:52.146Z',
    _updatedBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/orgLabel',
    _uuid: '8ae298d5-ccfd-4412-b066-788c57e328f8',
    '@context': ['https://bluebrain.github.io/nexus/contexts/organizations.json'],
  };
  return res(ctx.status(200), ctx.json(mockResponse));
});
