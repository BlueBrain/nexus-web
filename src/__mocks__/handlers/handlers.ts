...
export const deltaPath = (path?: string, mockDeltaAPIBasePath = defaultMockDeltaAPIBasePath) => {
  if (!path) {
...
export const handlers = [
  rest.post(
    ...
    (req, res, ctx) => {
      if (
        req.body?.toString().includes('@type: https://bluebrain.github.io/nexus/vocabulary/View')
      ) {
        const mockResponse = {
          hits: {
            hits: [
              {
                _id: 'https://bluebrain.github.io/nexus/vocabulary/defaultSparqlIndex',
                ...
                _source: {
                  ...
                  _createdBy: 'https://bbp.epfl.ch/nexus/v1/realms/bbp/users/kerrien',
                  _deprecated: false,
                  _incoming: 'https://bbp.epfl.ch/nexus/v1/views/nise/kerrien/graph/incoming',
                  _original_source:
                  ...
                  _outgoing: 'https://bbp.epfl.ch/nexus/v1/views/nise/kerrien/graph/outgoing',
                  _project: 'https://bbp.epfl.ch/nexus/v1/projects/nise/kerrien',
                  _rev: 1,
                  _self: 'https://bbp.epfl.ch/nexus/v1/views/nise/kerrien/graph',
                  _updatedAt: '2021-04-01T11:39:02.988Z',
                  _updatedBy: 'https://bbp.epfl.ch/nexus/v1/realms/bbp/users/kerrien',
              ...
              },
              {
                ...
                _source: {
                  ...
                  _createdBy: 'https://bbp.epfl.ch/nexus/v1/realms/bbp/users/kerrien',
                  _deprecated: false,
                  _incoming: 'https://bbp.epfl.ch/nexus/v1/views/nise/kerrien/documents/incoming',
                  _original_source:
                  ...
                  _outgoing: 'https://bbp.epfl.ch/nexus/v1/views/nise/kerrien/documents/outgoing',
                  _project: 'https://bbp.epfl.ch/nexus/v1/projects/nise/kerrien',
                  _rev: 1,
                  _self: 'https://bbp.epfl.ch/nexus/v1/views/nise/kerrien/documents',
          ...
          hits: [
            {
              ...
              _source: {
                '@id':
                  'https://bbp.epfl.ch/neurosciencegraph/data/8d65c507-06d1-4aa9-8b46-ea6a5cf07db5',
                '@type': 'https://bluebrainnexus.io/studio/vocabulary/StudioDashboard',
                label: 'Dashboard',
                ...
                _project: 'https://bbp.epfl.ch/nexus/v1/projects/nise/kerrien',
                _rev: 1,
                _schemaProject: 'https://bbp.epfl.ch/nexus/v1/projects/nise/kerrien',
                _self:
            ...
            },
            {
              ...
              _source: {
                ...
                _updatedBy: 'https://bbp.epfl.ch/nexus/v1/realms/bbp/users/neela',
              },
              _type: '_doc',
            },
            {
      ...
      _results: [
        {
          ...
          _deprecated: false,
          _incoming: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/graph/incoming',
          _outgoing: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/graph/outgoing',
        ...
        },
        {
          ...
          _createdBy:
            'https://dev.nise.bbp.epfl.ch/nexus/v1/realms/serviceaccounts/users/service-account-nexus-sa',
          _deprecated: false,
          _incoming: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/documents/incoming',
          _outgoing: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/documents/outgoing',
          _project: 'https://dev.nise.bbp.epfl.ch/nexus/v1/projects/copies/sscx',
          _rev: 1,
          _self: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/documents',
        ...
        },
        {
          ...
          _project: 'https://dev.nise.bbp.epfl.ch/nexus/v1/projects/copies/sscx',
          _rev: 1,
          _self: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/nxv:searchView',
        ...
        },
        {
          ...
          _project: 'https://dev.nise.bbp.epfl.ch/nexus/v1/projects/copies/sscx',
          _rev: 1,
          _self: 'https://dev.nise.bbp.epfl.ch/nexus/v1/views/copies/sscx/nxv:my-tagged-view',
  ...
  rest.get(deltaPath('/identities'), (req, res, ctx) => {
    const mockResponse = {
      ...
      identities: [
        ...
        {
          '@id': 'https://dev.nise.bbp.epfl.ch/nexus/v1/realms/local/users/localuser',
          '@type': 'User',
          realm: 'local',
          subject: 'localuser',
        },
  ...
  rest.get(deltaPath('/org/:label'), (req, res, ctx) => {
    ...
    const mockResponse = [
      {
        '@id': 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr1',
        '@type': 'Project',
        apiMappings: [],
        base: 'https://staging.nise.bbp.epfl.ch/nexus/v1/resources/test1/test1-pr1/',
        vocab: 'https://staging.nise.bbp.epfl.ch/nexus/v1/vocabs/test1/test1-pr1/',
        ...
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr1',
      ...
      {
        '@id': 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr2',
        '@type': 'Project',
        apiMappings: [
          {
        ...
        base: 'https://staging.nise.bbp.epfl.ch/nexus/v1/resources/test1/test1-pr2/_/',
        description: 'test project 2',
        vocab: 'https://staging.nise.bbp.epfl.ch/nexus/v1/vocabs/test1/test1-pr2/',
        _constrainedBy: 'https://bluebrain.github.io/nexus/schemas/projects.json',
        ...
        _organizationUuid: '8ae298d5-ccfd-4412-b066-788c57e328f8',
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr2',
    ...
    const mockResponse = [
      {
        ...
        _createdBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/test1',
        _deprecated: false,
        _label: 'TEST1',
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/orgs/Analysis-Plugin',
        _updatedAt: '2023-04-20T07:52:52.146Z',
        _updatedBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/test1',
      ...
      },
      {
        ...
        _constrainedBy: 'https://bluebrain.github.io/nexus/schemas/organizations.json',
        _createdAt: '2022-06-24T07:52:52.146Z',
        _createdBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/test2',
        _deprecated: false,
        _label: 'TEST2',
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/orgs/Analysis-Plugin',
        _updatedAt: '2023-04-20T07:52:52.146Z',
        _updatedBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/test2',
        _uuid: '8ae298d5-ccfd-4412-b066-788c57e328f8',
      },
      {
        ...
        _constrainedBy: 'https://bluebrain.github.io/nexus/schemas/organizations.json',
        _createdAt: '2022-06-24T07:52:52.146Z',
        _createdBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/test3',
        _deprecated: false,
        _label: 'TEST3',
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/orgs/Analysis-Plugin',
        _updatedAt: '2023-04-20T07:52:52.146Z',
        _updatedBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/test3',
        _uuid: '8ae298d5-ccfd-4412-b066-788c57e328f8',
      },
    ];
    return res(
  ...
  rest.get(deltaPath('/projects'), (req, res, ctx) => {
    const mockResponse = [
      ...
      {
        '@id': 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr3',
        '@type': 'Project',
        apiMappings: [
          {
            namespace: 'https://neuroshapes.org/dash/',
        ...
        base: 'https://staging.nise.bbp.epfl.ch/nexus/v1/resources/test1/test1-pr3/_/',
        description: 'test project 2',
        vocab: 'https://staging.nise.bbp.epfl.ch/nexus/v1/vocabs/test1/test1-pr3/',
        _constrainedBy: 'https://bluebrain.github.io/nexus/schemas/projects.json',
        _createdAt: '2023-04-20T09:27:43.752Z',
        _createdBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/meddah',
        _deprecated: false,
        ...
        _organizationUuid: '8ae298d5-ccfd-4412-b066-788c57e328f8',
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr3',
        _updatedAt: '2023-04-20T09:40:46.879Z',
        _updatedBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/meddah',
        _uuid: 'b2c8cb70-9163-4a7a-94a6-5641146f56de',
      },
      {
        '@id': 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr4',
        '@type': 'Project',
        apiMappings: [
          {
            namespace: 'https://neuroshapes.org/dash/',
        ...
        base: 'https://staging.nise.bbp.epfl.ch/nexus/v1/resources/test1/test1-pr4/_/',
        description: 'test project 2',
        vocab: 'https://staging.nise.bbp.epfl.ch/nexus/v1/vocabs/test1/test1-pr4/',
        _constrainedBy: 'https://bluebrain.github.io/nexus/schemas/projects.json',
        _createdAt: '2023-04-20T09:27:43.752Z',
        _createdBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/meddah',
        _deprecated: false,
        ...
        _organizationUuid: '8ae298d5-ccfd-4412-b066-788c57e328f8',
        _rev: 1,
        _self: 'https://staging.nise.bbp.epfl.ch/nexus/v1/projects/test1/test1-pr4',
        _updatedAt: '2023-04-20T09:40:46.879Z',
        _updatedBy: 'https://staging.nise.bbp.epfl.ch/nexus/v1/realms/bbp/users/meddah',
        _uuid: 'b2c8cb70-9163-4a7a-94a6-5641146f56de',
      },
