    ...
    const columns: ColumnsType<DataType> = [{
        ...
        render: (text) => (
            <div className='view-item-actions'>
                <Button type='link' htmlType='button' onClick={handleOnEdit}>Edit</Button>
                <Button type='link' htmlType='button' onClick={handleOnQuery}>Query</Button>
                <Button type='link' htmlType='button' onClick={handleOnDelete}>Delete</Button>
            </div>
        )
    }];
