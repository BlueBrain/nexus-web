...
const ProjectsListContainer: React.FC<ProjectsListContainerType> = ({ projects, projectType }) => {
  const [sortOrder, setSortOrder] = React.useState<string>('ASC');
  const [{ selectedOrg, selectedProject }, setSelectedProject] = React.useState<{
  ...
  return (
    <div>
      ...
      {projects
        .sort((v1, v2) => {
          if (sortOrder === 'ASC') {
            return v1._label.toLocaleUpperCase() > v2._label.toLocaleUpperCase() ? 1 : -1;
          }
          return v1._label.toLocaleUpperCase() < v2._label.toLocaleUpperCase() ? 1 : -1;
        })
              ...
              <div className="list-container">
                <div className="project-card-container">
                  <ProjectCard
                    ...
                    onClickEdit={() => onClickEditProject(_organizationLabel, _label)}
                  />
                </div>
              </div>
            </AccessControl>
